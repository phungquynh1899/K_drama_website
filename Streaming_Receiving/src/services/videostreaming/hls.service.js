...
class HLSService {
  constructor() {
    ...
    console.log(`HLS Service initialized with base path: ${this.hlsBasePath}`);
  }
  ...
  async hasHLSFiles(videoId) {
    try {
      ...
      console.log(`Checking HLS files for video ${videoId}:`);
      console.log(`  HLS path: ${hlsPath}`);
      console.log(`  Playlist path: ${playlistPath}`);
      console.log(`  HLS directory exists: ${fs.existsSync(hlsPath)}`);
