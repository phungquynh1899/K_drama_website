...
// const transferRouter = require('./routes/transfer/index.js');
// const emailRouter = require('./routes/email/index.js');
// const videometadataRouter = require('./routes/videometadata/index.js');
...
app.use((req, res, next) => {
    ...
    next(NotFound) //thảy cho error ha
    // 
    // dling kế tiếp
})
